...
const EncounterListTopInfo = ({savedEncounters, handleLoadEncounter, lastEncounterName, currentEncounterCreatures, clickEncounterDropdownMenuX, handleSaveEncounter, handleNewEncounter, saveMessageColor, showSaveMessage, isSaveDisabled}) => {
    return (
